...
if(mysqli_num_rows($result)  > 0) {     
    while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){         
        ...
        <td>" .$row['id']."</td>
            ...
            <td>" .$row['isbn_code']."</td>
            <td>" .$row['status']."</td>
            <td colspan='2'><a href='update.php?id=" .$row['id']."'><button class='btn btn-primary btn-md' type='button'>Edit</button></a></td>
...
<p class='h2'>Library</p>
           ...
           <div class="card">
           <div class="card-header">Books <div class="float-end"><a style="text-decoration:none" href= "actions/a_create.php">+Add Media</a></div></div>
